...
function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-white py-16 lg:py-20 scroll-mt-28">
...
function WhyChooseUsSection() {
  ...
  return (
    <section id="about" className="bg-white py-16 lg:py-20 scroll-mt-28">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8">
...
function AnnouncementsSection() {
  ...
  return (
    <section id="announcements" className="bg-white py-16 lg:py-20 scroll-mt-28">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8">
