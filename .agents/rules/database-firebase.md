# Skill Rule: database-firebase

> **Description & Purpose**: Firebase Firestore, Authentication, and Security Rules architecture. Use when designing NoSQL schemas, configuring Firebase Auth, writing Firestore security rules, setting up real-time listeners, or optimizing Spark free-tier quotas.
> **Skill Reference**: [SKILL.md](../skills/database-firebase/SKILL.md)

When this rule or skill is mentioned via `@database-firebase`, the agent must activate the **database-firebase** skill procedures and adhere strictly to its workflows.
