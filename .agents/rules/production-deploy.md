# Skill Rule: production-deploy

> **Description & Purpose**: Production build, deployment, and hosting configuration. Use when preparing Next.js apps for deployment on Netlify or Vercel, managing environment variables, configuring redirects/headers, setting up custom domains, or managing zero-downtime rollbacks.
> **Skill Reference**: [SKILL.md](../skills/production-deploy/SKILL.md)

When this rule or skill is mentioned via `@production-deploy`, the agent must activate the **production-deploy** skill procedures and adhere strictly to its workflows.
