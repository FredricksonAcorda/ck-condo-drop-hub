# Skill Rule: tailwind-v4-styling

> **Description & Purpose**: Tailwind CSS v4 styling, CSS-first design tokens, and responsive layout patterns. Use when creating UI components, configuring brand color palettes, defining typography tokens, or handling multi-breakpoint responsive reflow.
> **Skill Reference**: [SKILL.md](../skills/tailwind-v4-styling/SKILL.md)

When this rule or skill is mentioned via `@tailwind-v4-styling`, the agent must activate the **tailwind-v4-styling** skill procedures and adhere strictly to its workflows.
