# Skill Rule: nextjs-app-router

> **Description & Purpose**: Next.js App Router and React 19 architecture patterns. Use when building or optimizing routes, layouts, server vs client components, data fetching, server actions, route handlers, or caching in Next.js applications.
> **Skill Reference**: [SKILL.md](../skills/nextjs-app-router/SKILL.md)

When this rule or skill is mentioned via `@nextjs-app-router`, the agent must activate the **nextjs-app-router** skill procedures and adhere strictly to its workflows.
