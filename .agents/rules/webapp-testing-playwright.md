# Skill Rule: webapp-testing-playwright

> **Description & Purpose**: Playwright end-to-end and responsive UI testing. Use when writing automated browser tests, verifying user workflows (login, parcel claim, intake scanning), checking multi-viewport responsiveness, or running regression audits.
> **Skill Reference**: [SKILL.md](../skills/webapp-testing-playwright/SKILL.md)

When this rule or skill is mentioned via `@webapp-testing-playwright`, the agent must activate the **webapp-testing-playwright** skill procedures and adhere strictly to its workflows.
