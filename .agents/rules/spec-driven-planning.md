# Skill Rule: spec-driven-planning

> **Description & Purpose**: Spec-driven planning and architecture design. Use when scoping features, planning multi-phase projects, designing data models, breaking down complex tasks, or aligning requirements before writing code.
> **Skill Reference**: [SKILL.md](../skills/spec-driven-planning/SKILL.md)

When this rule or skill is mentioned via `@spec-driven-planning`, the agent must activate the **spec-driven-planning** skill procedures and adhere strictly to its workflows.
