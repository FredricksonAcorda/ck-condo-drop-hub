...
description: Supabase PostgreSQL database architecture, Row-Level Security (RLS), and Supabase Auth. Use when designing relational schemas, writing SQL migrations, defining RLS access policies, or integrating Supabase client into Next.js.
---
