---
name: code-refactor
description: Clean code refactoring and architecture cleanup. Use when improving code readability, reducing duplication (DRY), decoupling components, optimizing performance, or applying SOLID and Clean Architecture principles.
---
