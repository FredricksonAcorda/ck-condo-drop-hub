...
description: Web quality, performance, accessibility, and SEO audit. Use when evaluating Core Web Vitals (LCP, INP, CLS), auditing WCAG AA accessibility, optimizing bundle sizes, or verifying SEO metadata.
---
